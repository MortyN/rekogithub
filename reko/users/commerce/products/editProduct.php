...
?>
    ...
    <?php
        ...
        if(isset($_POST["submit"])){
            ...
            $result=mysqli_query($db,$sql) or ("<meta http-equiv='refresh' content='0;url=http://reko.opheim.as/users/commerce/products/editProduct.php?error=sql&prdID=$clickedPrdID'>") and die;

            if($result){
                print("<meta http-equiv='refresh' content='0;url=http://reko.opheim.as/users/commerce/products/editProduct.php?success=updateOK&prdID=$clickedPrdID'>");
            }
