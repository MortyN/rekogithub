...
<<<<<<< HEAD:var/www/html/www/sda/reko/users/customer/profile/orders.php
...
=======
                print("<tr><td>$orderID</td> <td>$firstName $lastName</td> <td>$products</td> <td>$date</td><td style='color:$color;'>$status</td> <td><a href='/users/commerce/order/showYourOrder.php?orderID=$orderID'>Se ordre</a></td></tr>");
>>>>>>> c9be52895f1975e540d539d881681786a1e3fdd2:reko/users/commerce/order/orders.php
            }
            ?>
        </table>
    </div>
