    ...
    <div class="prdOverview_container">
        <table class="prdOverview">
            ...
            for($i=1; $i<=$num; $i++){
                ...
                print("<tr><td>$orderID</td> <td>$firstName $lastName</td> <td>$products</td> <td>$date</td><td style='color:$color;'>$status</td> <td><a href='/www/sda/reko/users/commerce/order/showYourOrder.php?orderID=$orderID'>Rediger ordre</a></td></tr>");
            }
            ?>
        </table>
    </div>
