            ...
            <table class="chatOverview">
                ...
                for($i=1; $i<=$num; $i++){
                    ...
                    $usersUserID = $part["userID"];
                     ...
                     print("<tr><td><a href='http://opheimpi.zapto.org/www/sda/reko/users/moderator/chat/chat_overview.php?newChat=1&with=$usersUserID'>$firstName $lastName</a></td> <td><a href='http://opheimpi.zapto.org/www/sda/reko/users/moderator/chat/chat_overview.php?newChat=1&with=$usersUserID'>$type</a></td> <td><a href='http://opheimpi.zapto.org/www/sda/reko/users/moderator/chat/chat_overview.php?newChat=1&with=$usersUserID' style='color:$color;'>$online</a></td> </tr>");
                }
            }
                ?>
                </table>
