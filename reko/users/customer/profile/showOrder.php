...
<<<<<<< HEAD:var/www/html/www/sda/reko/users/customer/profile/showOrder.php
...
=======
            $result1=mysqli_query($db,$sql1) or ("<meta http-equiv='refresh' content='0;URL=http://reko.opheim.as/users/customer/profile/showOrder.php?error=sql&orderID=$orderID'/>") and die;
            $sql2= "DELETE FROM orders WHERE orderID = $orderID;";
            $result2=mysqli_query($db,$sql2) or ("<meta http-equiv='refresh' content='0;URL=http://reko.opheim.as/users/customer/profile/showOrder.php?error=sql&orderID=$orderID'/>") and die;

            if($result1 && $result2){
                print("<meta http-equiv='refresh' content='0;URL=http://reko.opheim.as/users/customer/profile/orders.php?success=deleteOK'/>");
>>>>>>> c9be52895f1975e540d539d881681786a1e3fdd2:reko/users/customer/profile/showOrder.php
            }
