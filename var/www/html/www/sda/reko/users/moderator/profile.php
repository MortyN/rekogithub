    ...
    <?php
        ...
        $newPath="/var/www/html/www/sda/reko/img/users/".$userID.'/'.$fileName;
            ...
            if($profileIMG != $fileName){
                ...
                $sql= "UPDATE users SET firstName ='$firstName1',lastName ='$lastName1',email='$email1',image='$fileName1',phoneNumber='$phone1' WHERE userID='$userID';";
            ...
            if($profileIMG == $fileName)
            {
                $sql= "UPDATE users SET firstName ='$firstName1',lastName ='$lastName1',email='$email1',phoneNumber='$phone1' WHERE userID='$userID1';";
