...
?>
  ...
  <h2> Din profil</h2>
    <form method="post" enctype="multipart/form-data" action="">
      ...
      <input type="submit"  value="Endre" name="editProfile" id="editProfile"><button onclick="window.location.href='/www/sda/reko/users/moderator/editPassword.php'" class="editPswBTN">Endre passord </button>
