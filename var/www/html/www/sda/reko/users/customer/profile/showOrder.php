...
?>
    ...
    <div class="prdOverview_container">
        ...
        if(isset($_POST["submit"])){
            ...
            $result1=mysqli_query($db,$sql1) or ("<meta http-equiv='refresh' content='0;URL=http://opheimpi.zapto.org/www/sda/reko/users/customer/profile/showOrder.php?error=sql'/>") and die;
            $sql2= "DELETE FROM orders WHERE orderID = $orderID;";
            $result2=mysqli_query($db,$sql2) or ("<meta http-equiv='refresh' content='0;URL=http://opheimpi.zapto.org/www/sda/reko/users/customer/profile/showOrder.php?error=sql'/>") and die;
