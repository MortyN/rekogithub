        ...
        <div class="chatBoxContainer">
            ...
            <div class="chat">
                ...
                <form class="msgForm" method="POST">
                    ...
                    <a id="msgReload" href="http://reko.opheim.as/users/commerce/chat/chat_box.php?chatID=<?php print($chatID);?>"><i class="icon-repeat"></i></a> 
    ...
    $('.messages').scrollTop($('.messages')[0].scrollHeight);
           ...
           if(isset($_POST["sendMsg"])){
               ...
               if(mysqli_query($db,$sql_newMsg)){
                echo "<meta http-equiv='refresh' content='0;url=http://reko.opheim.as/users/commerce/chat/chat_box.php?chatID=$chatID'>";
               }
               else{
