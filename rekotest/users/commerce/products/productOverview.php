    ...
    <div class="prdOverview_container">
        <table class="prdOverview">
            ...
            for($i=1; $i<=$num; $i++){
                ...
                print("<tr><td>$name</td> <td>$description</td> <td>$price</td> <td>$unit</td> <td style='color:$color;'>$status</td> <td><a href='/users/commerce/products/editProduct.php?prdID=$productID'>Rediger</a></td></tr>");
            }
            ?>
        </table>
    </div>
