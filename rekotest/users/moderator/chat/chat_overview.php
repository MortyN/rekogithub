            ...
            <table class="chatOverview">
                ...
                for($i=1; $i<=$num; $i++){
                    ...
                    $usersUserID = $part["userID"];
                     ...
                     print("<tr><td><a href='http://reko.opheim.as/users/moderator/chat/chat_overview.php?newChat=1&with=$usersUserID'>$firstName $lastName</a></td> <td><a href='http://reko.opheim.as/users/moderator/chat/chat_overview.php?newChat=1&with=$usersUserID'>$type</a></td> <td><a href='http://reko.opheim.as/users/moderator/chat/chat_overview.php?newChat=1&with=$usersUserID' style='color:$color;'>$online</a></td> </tr>");
                }
            }
                ?>
                </table>
            ...
            if(isset($_GET["newChat"])){
                if($_GET["newChat"] == 1){
                    ...
                    if(mysqli_query($db,$newChat)){
                        ...
                        echo "<meta http-equiv='refresh' content='0;url=http://reko.opheim.as/users/moderator/chat/chat_box.php?chatID=$newChatID'>";
                    }
                    else{
