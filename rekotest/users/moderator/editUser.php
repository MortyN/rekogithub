          ...
          if(isset($_POST['submit'])){
            ...
            if ($delIMG == "imagedel") {
              ...
              if (!filter_var($newEmail, FILTER_VALIDATE_EMAIL)) {
                echo "<meta http-equiv='refresh' content='0;url=http://reko.opheim.as/users/moderator/editUser.php?error=email&userID=$selectedUserID'>" and die;
              } 
              else{
              ...
              mysqli_query($db,$query) or ("<meta http-equiv='refresh' content='0;url=http://reko.opheim.as/users/moderator/editUser.php?error=sql&userID=$selectedUserID'>") and die;

              echo "<meta http-equiv='refresh' content='0;url=http://reko.opheim.as/users/moderator/editUser.php?success=updateOK&userID=$selectedUserID'>";
              }

              
              

              $path="/img/users/".$userID.'/'.$image;
              unlink($path) or ("<meta http-equiv='refresh' content='0;url=http://reko.opheim.as/users/moderator/editUser.php?error=server&userID=$selectedUserID'>") and die;
            ...
            if(!$delIMG){
              if (!filter_var($newEmail, FILTER_VALIDATE_EMAIL)) {
                echo "<meta http-equiv='refresh' content='0;url=http://reko.opheim.as/users/moderator/editUser.php?error=email&userID=$selectedUserID'>";
              }
              else{
