...
<div class="mobileNav">
        ...
        <a id="aMobile" href="/users/customer/dashboard.php">Info</a>
        <a id="aMobile" href="/users/customer/chat/chat_overview.php">Dine meldinger</a><br>
        <a id="aMobile" href="/users/customer/profile/orders.php">Dine ordre</a>
        ...
        <h2>Profil</h2>
        <a id="aMobile" href="/users/customer/profile/profile.php">Endre profil</a>
...
<div class="sidenav">
  ...
  <a href="/users/customer/dashboard.php">Info</a>
    ...
    <a href="/users/customer/profile/profile.php">Endre profil</a>
    <a href="/users/customer/chat/chat_overview.php">Dine meldinger</a>
    <a href="/access/logout.php">Logg ut</a>
